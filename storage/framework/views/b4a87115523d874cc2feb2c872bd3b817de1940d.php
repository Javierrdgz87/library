...
<?php $__env->startSection('content'); ?>
	...
	<div class="container">
		...
		<form method="POST" action="<?php echo e(route('categorias.update', $aDatos->eCodCategoria)); ?>">
		    	...
		    	<div class="panel-body">
					...
					<?php endif; ?>
			     	<div class="row">
				      	...
				      	<div class="col-md-4">
				      		<div class="form-group">
							    <label for="tDescripcion">Descripci&oacute;n</label>
							    <input type="text" class="form-control" id="tDescripcion" name="tDescripcion" placeholder="Descripci&oacute;n" value="<?php echo e($aDatos->tDescripcion); ?>">
							</div>
		      			</div>
		      		</div>
		      		<?php if(0 < count($aDatos->libros) ): ?>
			      		<div class="row">
			      			<div class="col-md-4">
			      				<label for="">Libros relacionados</label>
			      				<ul>
				      			<?php $__currentLoopData = $aDatos->libros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<li><?php echo e($value->tNombre); ?></li>
				      			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				      			</ul>
